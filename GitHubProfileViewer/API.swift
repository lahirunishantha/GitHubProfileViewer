...
public final class SampleGitHubUserQuery: GraphQLQuery {
  ...
  public let operationName: String = "SampleGitHubUser"
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public struct PinnedItem: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(id: GraphQLID, name: String, description: String? = nil, stargazerCount: Int, primaryLanguage: AsRepository.PrimaryLanguage? = nil) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "description": description, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: AsRepository.PrimaryLanguage) -> ResultMap in value.resultMap }])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(id: GraphQLID, name: String, description: String? = nil, stargazerCount: Int, primaryLanguage: PrimaryLanguage? = nil) {
              self.init(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "description": description, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: PrimaryLanguage) -> ResultMap in value.resultMap }])
            }
